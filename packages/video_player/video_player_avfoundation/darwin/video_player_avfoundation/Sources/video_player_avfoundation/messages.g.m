...
@interface FVPBufferConfigNative ()
...
+ (instancetype)makeWithUri:(NSString *)uri
  ...
  pigeonResult.bufferConfig = bufferConfig;
  return pigeonResult;
}
+ (FVPCreationOptions *)fromList:(NSArray<id> *)list {
  FVPCreationOptions *pigeonResult = [[FVPCreationOptions alloc] init];
  ...
  pigeonResult.bufferConfig = GetNullableObjectAtIndex(list, 2);
  return pigeonResult;
}
+ (nullable FVPCreationOptions *)nullableFromList:(NSArray<id> *)list {
...
+ (nullable FVPBufferConfigNative *)nullableFromList:(NSArray<id> *)list {
  return (list) ? [FVPBufferConfigNative fromList:list] : nil;
}
- (NSArray<id> *)toList {
  return @[
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 131: 
      return [FVPBufferConfigNative fromList:[self readValue]];
    case 132: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FVPPlatformVideoViewCreationParams class]]) {
    ...
    [self writeByte:130];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[FVPBufferConfigNative class]]) {
    [self writeByte:131];
    [self writeValue:[value toList]];
